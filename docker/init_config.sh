...
export SPRING_DATASOURCE_DYNAMIC_DATASOURCE_ACCESS_LOG_DB_URL=${LOG_DB_URL}
...
export SPRING_DATASOURCE_DYNAMIC_DATASOURCE_ACCESS_LOG_DB_DRIVER_CLASS_NAME=${LOG_DB_DRIVER}
