  ...
  <div>
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="模式">
        ...
        <el-alert title="除了黑名单列表中的IP禁止访问API，其他IP一律允许访问" type="warning" :closable="false" v-show="mode == 'black'"></el-alert>
        <el-alert title="只有白名单列表中的IP才允许访问API，其他IP一律禁止访问" type="warning" :closable="false" v-show="mode == 'white'"></el-alert>
      </el-form-item>
